...
$config['public_controller']=array('translator','img', 'dashboard');
...
// Session will store the user_id of loged in user
$config['login_session_key']="user_id";
...
$config['password_recovery_email']="noreply@xiidea.net";
...
$config['assets_base_directory']='assets/ezrbac';
